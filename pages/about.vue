      ...
      <page-article class="w-full md:w-9/12 lg:w-9/12 xl:w-8/12 2xl:w-7/12">
        <page-article-section>
          <div class="flex flex-col md:flex-row">
            <div class="basis-full md:basis-6/12 mb-5 md:mb-0">
              <p>
            ...
            <div class="basis-full md:basis-6/12">
              <div class="me-details flex flex-wrap">
                <me-details name="Name" value="Matt DeKok" />
                <me-details name="Age" :value="age(new Date('1988-05-09T00:00:00-05:00'))" />
                <me-details name="Location" value="SD" />
                <me-details name="Experience" :value="`${age(new Date('2006-06-01T00:00:00-05:00'))} years`" />
              </div>
              <div>&nbsp;</div>
              <div class="flex flex-wrap gap-4 justify-center">
                <a href="https://www.linkedin.com/in/matt-dekok/" title="LinkedIn" target="_blank">
                  <svg viewBox="0 0 291 79.459999" class="h-6">
                    <g transform="translate(-200.55198,-393.96227)">
                      <g transform="matrix(1.018827,0,0,-1.018827,170.5996,498.03288)" id="g3019">
                        <path
                          ...
                          id="path14"
                        />
                        <path d="m 31.1516,37.709 31.0356,0 0,10.189 -19.8042,0 0,38.874 -11.2314,0 0,-49.063 z" fill="var(--LinkedIn)" id="path16" />
                        <path
                ...
                <a href="https://github.com/sillvva" title="GitHub" target="_blank">
                  <svg viewBox="0 0 560 150" class="h-6">
                    <g transform="matrix(4.16667,0,0,4.16667,74.8679,142.736)">
                      <path
        ...
        <page-article-section>
          <div class="text-center">
            <p class="pb-4">Like and want to support my work? No problem!</p>
